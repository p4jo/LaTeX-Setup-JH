...
\newcommand\drawLeftBottomLine[2][-8pt]{ % #2=the color
    \draw[line~width = 2pt, #2, opacity = 0.7]
        ([ shift = { (1pt, #1) } ] interior.north~west )
    -- ([ shift = { (1pt, 0pt) } ] interior.south~west )
    -- ([ shift = { (1pt, 0pt) } ] interior.south~east );
}
...
\newtcolorbox{leftLineBox}[2][]{
    ...
    overlay~unbroken~and~first={ \drawLeftLine[-25pt]{#2} },
...
\newtcolorbox{leftBottomLineBox}[2][]{
    ...
    left=7pt,
    parbox=false, % this fixes the indentation of paragraphs
    overlay~first={ \drawLeftLine[-25pt]{#2} },
    overlay~middle={ \drawLeftLine{#2} },
    overlay~last={ \drawLeftBottomLine{#2} },
    overlay~unbroken={ \drawLeftBottomLine[-25pt]{#2} },
    #1
}
...
\declaretheoremstyle[
    bodyfont=\upshape,
    headfont={\hspace{-11pt}\sffamily\bfseries},
